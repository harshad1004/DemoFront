        ...
        <section className="product_section layout_padding">
         <div className="container">
            ...
            <div className="btn-box" >
               <button  style={{boxShadow:"0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19)", color:"red", width:"150px" , height:"44px", borderRadius:"30px"}} onClick={LoadMoreImages}>
                Load More
               </button>
            </div>
         </div>
